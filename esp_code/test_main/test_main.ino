...
// WiFi
const char *ssid = "La_Fibre_dOrange_2.4G_3C4E"; // Enter your WiFi name
const char *password = "@Passw0rd8422";  // Enter WiFi password

// MQTT Broker
const char *mqtt_broker = "test.mosquitto.org";
const char *topic = "tkhrbika/youss";
